...
DocPad = (function(_super) {
  ...
  */
  ...
  function DocPad(instanceConfig, next) {
    ...
    var action, configEventContext, docpad, logger, _ref1;
    ...
    eachr(this.getEvents(), function(eventName) {
    ...
    this.collections = {};
    this.blocks = {};
    this.database = new FilesCollection();
  ...
  DocPad.prototype.load = function(instanceConfig, next) {
    ...
    preTasks.addTask(function(complete) {
      ...
      return safefs.exists(envPath, function(exists) {
        ...
        return safefs.readFile(envPath, function(err, data) {
  ...
  DocPad.prototype.loadConfigPaths = function(configPaths, next) {
    ...
    eachr(configPaths, function(configPath) {
  ...
  DocPad.prototype.loadPlugins = function(next) {
    ...
    eachr(this.config.pluginsPaths || [], function(pluginsPath) {
      var exists;
    ...
    eachr(this.config.pluginPaths || [], function(pluginPath) {
      var exists;
    ...
    renderCollection = function(collectionToRender, _opts, next) {
      ...
      if (typeof opts.setProgressIndicator === "function") {
        opts.setProgressIndicator(function() {
          ...
          return ['renderFiles' + (_opts.renderPass > 1 ? " (pass " + _opts.renderPass + ")" : ''), _opts.offset + totals.completed, _opts.total];
        });
      }
  ...
  DocPad.prototype.generateParse = function(opts, next) {
    ...
    this.emitSync('parseBefore', {}, function(err) {
      ...
      eachr(config.documentsPaths, function(documentsPath) {
        return tasks.addTask(function(complete) {
      ...
      eachr(config.filesPaths, function(filesPath) {
        return tasks.addTask(function(complete) {
      ...
      eachr(config.layoutsPaths, function(layoutsPath) {
        return tasks.addTask(function(complete) {
          return docpad.parseDocumentDirectory({
            path: layoutsPath,
            collection: database
